...
import 'package:class_a_ec/core/utils/secure_storage.dart';
...
abstract class BaseDioHelper {
  ...
  Future download({required String url, required String path});
}
  ...
  Future request({
    ...
    try {
      ...
      throw PrimaryServerException(
        ...
        message: e.response?.data['exception'] ?? e.response!.toString(),
      );
    } catch (e) {
